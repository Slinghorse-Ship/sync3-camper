...
Item {
    ...
    property var stateData: ({
        ...
        weather: {
            ...
            station: { id: "10384", name: "Berlin-Tempelhof", distanceKm: 4.2 },
            ...
            tides: {
                ...
                station: { id: "wilhelmshaven_alter_vorhafen", name: "Wilhelmshaven Alter Vorhafen", distanceKm: 326.3 },
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="camper-control-preview-") as directory:
        ...
        view = PreviewView()
        view.setTitle("CamperControl v3.12.1 – lokale UI-Vorschau (keine Hardware)")
